...
String altProfilePic = FirebaseAuth.instance.currentUser.photoURL;
const String altChannelArt =
    "https://image.freepik.com/free-vector/gradient-white-monochrome-background_52683-66309.jpg";
// const String altUserId = "Pon1uG0eNnhf9TLsps0jtScndtN2";
String altUserId = FirebaseAuth.instance.currentUser.uid;
const String altAdPostId = "b3ifO4H0zlVdAizNbsat";
...
class States {
  String code, label;
  States({this.code, this.label});
}

class Districts {
  String state;
  List<String> districts;
  Districts(this.districts, this.state);
}

// List<State> states = [
//   State(code: "AN", label: "Andaman and Nicobar Islands"),
...
//   { code: "DH", label: "Dadra and Nagar Haveli" },
...
//   { state: "AN", districts: ["Andaman and Nicobar Islands"] },
