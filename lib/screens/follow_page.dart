...
class _Screen9State extends State<Screen9> {
  ...
  Widget build(BuildContext context) {
   var currentuserid=" 4C4iLByizTPLBBlP4rssrwGTISb2";
            ...
            Container(
              ...
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    .collection('followers').where('', arrayContainsAny: ['en', 'it']).snapshots(),
                ...
                builder: (BuildContext context,
                  ...
                  channels.where('id', isEqualTo: data['follower']).get().then((value) => print("what i need"+value.toString()));
                    return FutureBuilder<DocumentSnapshot>(
                      future: channels.doc().get(),
                      builder: (BuildContext context,
                        ...
                        if (snapshot.connectionState == ConnectionState.done) {
                          // snapshot
                          //     .where('id', isEqualTo: data['follower'])
                          //     .get();
