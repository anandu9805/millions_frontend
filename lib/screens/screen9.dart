...
class _Screen9State extends State<Screen9> {
  ...
  Widget build(BuildContext context) {
    ...
    List d2=[],d=[];
    var currentuserid="4C4iLByizTPLBBlP4rssrwGTISb2";//the id of the logged in user
            ...
            Container(
              ...
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    .collection('followers')//.where('follower', arrayContainsAny: [currentuserid])
                    .snapshots(),
  ...
  return FutureBuilder<DocumentSnapshot>(
    ...
    builder: (BuildContext context,
      ...
      if (snapshot.connectionState == ConnectionState.done) {
        channeldata = snapshot.data.data() as Map<String, dynamic>;
        ...
        return Row(children: [
          Column(
            children: [
              ...
              Text( channeldata['channelName'], style: GoogleFonts.ubuntu())
            ],
          ),
          SizedBox(
            width: 5,
